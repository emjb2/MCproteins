...
def find_tetramer_sites(n, loc, buckets):
    ...
    height = buckets[loc]
    viable_locs = []
    last_pieces = [find_neighbours(n, neighbours[0])[2], find_neighbours(n, neighbours[1])[2], find_neighbours(n, neighbours[1])[3], find_neighbours(n, neighbours[0])[3]]
    ...
    if buckets[neighbours[2]] == buckets[neighbours[1]] == buckets[last_pieces[1]] == height:
        viable_locs.append([neighbours[2], neighbours[1], last_pieces[1], loc])
