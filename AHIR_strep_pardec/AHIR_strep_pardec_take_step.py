...
def AHIR_strep_pardec_take_step(n, positions, heights, deltaMu, T, decoration_dist):
    ...
    if z < attachment_prob/summ and attachment_possible == 1:
        ...
        if decoration_dist[-1] == 0:
            if current_stack%2 == 1:
                current_stack = choices(find_neighbours(n, current_stack))[0]
