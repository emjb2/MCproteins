...
def AHIR_strep_take_step(n, AHIR_strep_dist, positions, strep_only, both, heights, deltaMu, T, Epb, phi):
    track = 0
    ...
    if whats_there_now == 0:
        ...
        h = ((how_many_neighbours(n, current_stack, heights, positions))/2)*(phi/Epb)
    else:
